...
<form id="searchFreeBoardVO" action="/usermadang/board/freeBoardUpdate.do" method="post">
	<input id="searchKeyCode" name="searchKeyCode" type="hidden" value=""/>
...
<form id="freeBoardVO" action="/usermadang/board/freeBoardUpdate.do" method="post">
