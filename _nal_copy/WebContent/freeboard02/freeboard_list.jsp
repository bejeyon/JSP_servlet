<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="ko" xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko"><head>
...
<!--                                         <li class="menu03"><a href="/datasearch/issuebook/selectIssueBookList.do">현안과 책</a></li> -->
                                        ...
                                        <li class="menu04"><a href="https://www.nanet.go.kr/webzine/202212/main.html" target="_blank" class="wu" title="새창열기">국회도서관 웹진</a></li>
...
<!--                                         <li class="menu03"><a href="/usermadang/etc/payDonateView.do">납본·기증</a></li> -->
    ...
    <div class="popupMenu" style="display: none;">
        ...
        <div class="popupContainer">
            ...
            <!-- 모바일용 로그인 -->
            <div class="loginList mo" style="display: none;">
...
<!--                         <li><a href="/datasearch/issuebook/selectIssueBookList.do">현안과 책</a></li> onclick="javascript:eBook(); return false;"-->
                        ...
                        <li><a href="https://www.nanet.go.kr/webzine/202212/main.html" target="_blank" class="wu" title="새창열기">국회도서관 웹진</a></li>
...
<!--                 <li data-url="/usermadang/etc/payDonateView.do"><a href="/usermadang/etc/payDonateView.do">납본·기증</a></li> -->
                ...
                <li data-url="/libaryuseinfo/faqServiceList.do, /libaryuseinfo/selectQnaList.do, /libaryuseinfo/selectQnaDetail.do,
                                ...
                                /usermadang/board/freeBoardAnswer.do, /usermadang/board/reFreeBoardForm.do, /libaryuseinfo/qnaWriterForm.do, /libaryuseinfo/selectQnaModeForm.do" class="on">
                    <a href="/libaryuseinfo/faqServiceList.do">게시판</a>
                    <ul>
                        ...
                        <li data-url="/usermadang/board/freeBoardList.do, /usermadang/board/freeBoardDetail.do, /usermadang/board/freeBoardForm.do,
                                        /usermadang/board/freeBoardAnswer.do, /usermadang/board/reFreeBoardForm.do" class="on">
