...
js_rolling.prototype.init = function(){
	...
	this.box.onmouseout=function(){
		if(!thisC.mouseover_pause && this.is_rolling){return;}
...
js_rolling.prototype.start = function(){ //롤링 시작
	...
	$('.banner_ctrl li:nth-child(2) a').attr("style","width:20px;height:20px;background:url('/images/bxslider/btn_stop_slider.gif') no-repeat left top;text-indent:-9999px;");
	$('.banner_ctrl li:nth-child(2) a').attr("title","멈춤");
	$('.banner_ctrl li:nth-child(2) a').attr("onclick", "t4.stop(); return false;");
	
	this.time_timer = setInterval(act,this.time_dealy);
}
js_rolling.prototype.stop = function(){ //롤링을 끝냄
	this.is_rolling = false;
	$('.banner_ctrl li:nth-child(2) a').attr("style","width:20px;height:20px;background:url('/images/bxslider/btn_play_slider.gif') no-repeat left top;text-indent:-9999px;");
	$('.banner_ctrl li:nth-child(2) a').attr("title","시작");
	$('.banner_ctrl li:nth-child(2) a').attr("onclick", "t4.start(); return false;");
	if(!this.time_timer){
