...
////과거 코드 여러개의 웹서버에서 중복처리
	...
	System.out.println("BoardController6 ");
		...
		try {
			...
			for (int i = 0; i < items.size(); i++) {
				...
				if (fileItem.isFormField()) {
					System.out.println("FileItem "+fileItem.getFieldName() + "=" + fileItem.getString(encoding));
