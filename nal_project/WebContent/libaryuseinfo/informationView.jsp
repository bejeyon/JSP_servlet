...
<link rel="stylesheet" type="text/css" href="/resource/css/new_common.css?v=202212161650">
<link rel="stylesheet" type="text/css" href="/resource/css/jquery.bxslider.css?v=202212161650">
<link rel="stylesheet" type="text/css" href="/resource/css/fonts.css?v=202212161650">
...
<link rel="stylesheet" type="text/css" href="/resource/css/select2.css?v=202212161650"/>
...
<link rel="stylesheet" type="text/css" href="/resource/css/select2_old.css?v=202212161650"/>
<script type="text/javascript" src="/resource/js/select2.min.js"></script>
...
<!--                                 /comnet/academeet/meetReqInfoView.do, /comnet/academeet/meetReqestList.do, /comnet/academeet/meetRegistryForm.do, /comnet/academeet/meetRegistryList.do, /comnet/academeet/meetTour.do"><a href="/comnet/academeet/meetConferensView.do">제20차 정기총회 및 콘퍼런스</a></li> -->
                ...
                <li data-url="/libaryuseinfo/libUseUserTimeView.do, /libaryuseinfo/libSetepCencelView.do, /libaryuseinfo/libUseYoungPeople.do, /libaryuseinfo/disblePersonUseView.do,
                    ...
                    <ul>
                        ...
                        <li data-url="/libaryuseinfo/infomationView.do"><a href="/libaryuseinfo/infomationView.do">자료실</a></li>
							...
							<table class="normalTable">
								...
								<tr>
									...
									<td class="end">
										<div class="box00 overflowH">
											<ul>
												<li data-tab="classListCon01" class="infoMenu01 mb0"><a href="#">의원열람실<span class="blind" id="classListCon01"></span></a></li>
												<li data-tab="classListCon02" class="end infoMenu02  mb0"><a href="#">정기간행물실<span class="blind"  id="classListCon02"></span></a></li>
											</ul>
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="end">
										<div class="box00 overflowH">
											<ul>
												<li data-tab="classListCon04" class="end infoMenu04 mb0"><a href="#">인문ㆍ자연과학자료실<span class="blind"  id="classListCon04"></span></a></li>
<!-- 												<li data-tab="classListCon16" class="end infoMenu16 mb0"><a href="#">연구데이터센터(RDC)</a></li> -->
								...
								<tr>
									...
									<td class="end">
										<div class="box00 overflowH">
											<ul>
												<li data-tab="classListCon05" class="end infoMenu05 mb0"><a href="#">디지털정보센터 &nbsp;|&nbsp; 독도·통일자료실<span class="blind"  id="classListCon05"></span></a></li>
											</ul>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td class="end">
										<div class="box00 overflowH">
											<ul>
												<li data-tab="classListCon06" class="infoMenu06 mb0"><a href="#">사회과학자료실<span class="blind"  id="classListCon06"></span></a></li>
												<li data-tab="classListCon07" class="end infoMenu07 mb0"><a href="#">법률정보센터<span class="blind"  id="classListCon07"></span></a></li>
											</ul>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td class="end">
										<div class="box00 overflowH">
											<ul>
												<li data-tab="classListCon08" class="infoMenu08 mb0 current"><a href="#">대출대<span class="blind"  id="classListCon08"></span></a></li>
												<li data-tab="classListCon09" class="infoMenu09 mb0"><a href="#">국가전략정보센터<span class="blind"  id="classListCon09"></span></a></li><!-- ㆍ석박사학위논문실 -->
												<li data-tab="classListCon17" class="infoMenu17 mb0"><a href="#">빅데이터연구센터<span class="blind"  id="classListCon17"></span></a></li>
												<li data-tab="classListCon11" class="infoMenu11 mb0"><a href="#">복사실<span class="blind"  id="classListCon11"></span></a></li>
												<li data-tab="classListCon10" class="infoMenu10 mb0"><a href="#">어린이방<span class="blind"  id="classListCon10"></span></a></li>
												<li data-tab="classListCon18" class="infoMenu18 mb0"><a href="#">장애인석<span class="blind"  id="classListCon18"></span></a></li>
												<li data-tab="classListCon19" class="end infoMenu19 mb0"><a href="#">상설전시실<span class="blind"  id="classListCon19"></span></a></li>
											</ul>
										</div>
									</td>
								</tr>
						...
						<div class="mapImageComent mt50 classListCon01 current">
							<div class="mapImg">
								<img src="/images/img/img_5F_01.jpg" alt="5층평면도 - 1.의원열람실 위치 : 일반인출입구방향쪽 엘레베이터 옆에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 여자화장실" />
							</div>
							<div class="subBoxTxt mt20 subBoxTxt28">
								<h4>간략소개</h4>
								<ul>
									<li>
										의원열람실은 국회의원을 위한 열람실로 국회도서관과 의원회관 2곳에 위치하고 있으며, 전·현직 의원
										저서, 입법 및 정책 관련 신간도서, 신문 및 시사잡지 등을 비치하고, 의회활동과 관련된 참고봉사를 제공하고
										있습니다.
									</li>
									<li>의원회관 의원열람실에서는 국회의원실을 대상으로 「국회의원실 대출도서전달서비스」를 제공하고 있습니다.</li>
								</ul>
							</div>
<!-- 							<div class="subBoxTxt"> -->
<!-- 								<h4>이용시간</h4> -->
...
<!-- 							</div> -->
							...
							<div class="subBoxTxt">
								<h4>
									...
									<span class="btnView m_ml10" style="float: none; margin-left: 10px; display: inline-block;">
										<a href="/usermadang/etc/copyServiceView.do" title="자료복사 바로가기 "><img src="/images/bg/btn_icon_001.png" alt="">자료복사 바로가기</a>
									</span>
								</h4>
							</div>
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 : 5층 517호(☎02-6788-4134)</li>
									<li>의원회관 : 2층 205호(☎02-6788-4378, 4194)</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon02">
							<div class="mapImg">
								<img src="/images/img/img_5F_02.jpg" alt="5층평면도 - 1.정기간행물실 위치 : 일반인출입구방향쪽 엘레베이터를 내려 법률정보총괄과,국회사무처,의정연수원교수실,독도조사관실을 지나 독도조사관실 옆 해외자료관실 맞은편에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 여자화장실" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략소개</h4>
								<ul>
									<li>정기간행물실은 국내·외 정기간행물, 대학간행물, 국제기구자료, 마이크로폼자료를 소장하고 있습니다.</li>
								</ul>
							</div>
							<div class="subBoxTxt">
								<h4>이용시간</h4>
								<ul class="mb10">
									<li>월~금: 09:00 ~ 21:00</li>									
...
<!-- 									<a href="#" style="width:130px;">열람신청 방법 보기</a> -->
...
<!-- 								<ul class="ml40 mb0"> -->
<!-- 									<li class="ml0 bgNo pL0">ㆍ2016년 이후 국제기구자료 : 자료실에서 직접이용(청구기호 순 배열)</li> -->
<!-- 									<li class="ml0 bgNo pL0">ㆍ2015년 이전 국제기구자료 : 온라인 열람신청(원문구축 시 원문 이용)</li> -->
<!-- 								</ul> -->
								<ul class="mb0">
							...
							<!-- <div class="subBoxTxt">
								<h4>
									자료복사 
									<span class="btnView m_ml10" style="float: none; margin-left: 10px; display: inline-block;">
										<a href="/usermadang/etc/copyServiceView.do"><img src="/images/bg/btn_icon_001.png" alt="">자료복사 바로가기</a>
									</span>
								</h4>
							</div> -->
							<div class="subBoxTxt">
								...
								<ul>
									<li>국회도서관 5층 524호</li>
									<li>정기간행물 및 국제기구자료: 02-6788-4208,4142,4169</li>
									<li>마이크로폼자료: 02-6788-4240</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon04">
							<div class="mapImg">
								<img src="/images/img/img_3F_01.jpg" alt="3층평면도 - 1.인문자연과학자료실 및 대면낭독실 위치 : 일반인출입구방향쪽 엘레베이터를 내려 제1회의실,도서관장실,총무담당관실 지나 총무담당관실 옆 기획관리실 맞은편에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 여자화장실" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략소개</h4>
								<ul>
									<li>인문자연과학자료실(314호)은 철학, 문학 등의 인문학과 수학, 의학, 공학 등의 자연과학 분야의 단행본을 소장하고 있는 개가제 자료실입니다. 또한 ‘신간도서’, ‘베스트셀러’, ‘책으로 말을 걸다’(기획전시), ‘국내외 문학상 수상도서’, ‘여행안내서’ 등 다양한 전시 코너를 마련하여 서비스하고 있으며, 별도의 연구조사실(2실)과 시각장애인에게 낭독서비스를 제공할 수 있는 대면낭독실(대면낭독 전용공간)도 운영하고 있습니다.
									</li>
								</ul>
...
<!-- 								</p> -->
								...
								<ul class="mb10">
									...
									<span class="btnView m_ml10" style="float: none; display: inline-block;">
										<a href="/usermadang/etc/nightUseReqView.do" target="_blank" title="새창열기">
											<img src="/images/bg/btn_icon_001.png" alt="">
											야간이용신청 안내
										</a>
									</span>									
									</li>
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 3층 314호(02-6788-4165, 4183)</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon05">
							<div class="mapImg">
								<img src="/images/img/img_3F_02.jpg"
							...
							<div class="subBoxTxt mt20">
								<h4>간략소개</h4>
								<ul>
									<li>디지털정보센터(의정관 3층)는 CD, DVD, 비디오테이프 등의 멀티미디어 자료와 연감, 백서 등의 참고도서를 소장하고 있으며, 열람용 PC에서 웹DB와 전자책을 이용할 수 있습니다.</li>
									<li>독도·통일자료실은 국·내외 독도 관련 자료, 영토 관련 국제법 자료 및 고지도, 남북한 통일 관련 자료와 북한 발행자료 등을 소장하고 있습니다.</li>
								</ul>
							</div>
							<div class="subBoxTxt">
								<h4>이용시간</h4>
...
<!-- 											<img src="/images/img/btn_icon_001_01.png" alt="" />좌석예약 바로가기 」 -->
<!-- 											</a> -->
<!-- 										</div> -->
									</li>
...
<!-- 										<a href="#" style="width:118px;">열람신청 방법 보기</a> -->
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회의정관 3층(국회도서관 2층 연결통로로 이동)</li>
									<li>웹DB, 전자책, 멀티미디어: 02-6788-4362</li>
									<li>참고자료: 02-6788-4191</li>
									<li>독도·통일자료: 02-6788-4236</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon06">
							<div class="mapImg">
								<img src="/images/img/img_2F_01.jpg"
							...
							<div class="subBoxTxt mt20">
								...
								<ul>
									<li>
										사회과학자료실(208호)은 사회학, 정치학, 경제학 등 사회과학분야의 단행본(법학 분야   제외)을 소장하고 있는 개가제 자료실입니다. 또한 국내외 신문을 비치하여 서비스하고 있으며,‘베스트셀러’, ‘신간도서’, ‘책으로 말을 걸다’(기획전시) 등 전시 코너를 마련하여 운영하고 있습니다.
									</li>
								</ul>
								<p class="depthTxt pml20 pmtn20">
...
<!-- 								</p>  -->
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 2층 208호(도서: 02-6788-4130, 신문: 02-6788-4140)</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon07">
							<div class="mapImg">
								<img src="/images/img/img_2F_02.jpg"
									alt="2층평면도 - 1.법률정보센터 위치 : 일반인출입구방향쪽 엘레베이터를 내려 오른쪽에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 여자화장실, 여자장애인화장실" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략소개</h4>
								<ul>
									<li>법률정보센터는 법학도서, 법령자료, 의회자료 등을 소장하고 있으며, 외국법률번역DB,
										법률쟁점서비스, 국회회의록 등 다양한 법률정보 서비스를 이용할 수 있습니다.</li>
								</ul>
							</div>
<!-- 							<div class="subBoxTxt"> -->
<!-- 								<h4>이용시간</h4> -->
...
<!-- 							</div> -->
							...
							<div class="subBoxTxt">
								<h4>
									이용방법
									<span class="btnView m_ml10 pop_use" style="float: none; margin-left: 10px; display: inline-block;">
<!-- 										<a href="#" style="width:90px;">이용방법 보기</a> -->
										<button class="btn_navy" data-focus="popUse" style="border-radius: 0">열람신청 방법 보기</button>
									</span>
								</h4>
								<ul class="mb10">
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>위치 : 국회도서관 2층 206호</li>
									<li>법학도서 및 법령자료 : ☎ 02-6788-4132</li>
									<li>의회자료 : ☎ 02-6788-4242</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon08">
							<div class="mapImg">
								<img src="/resource/images/img_1F_01.jpg"
									alt="1층평면도 - 1.대출대 위치 : 일반인출입구로 입장하여 출입게이트를 지나 중앙홀을 가로질러 맞은편에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 남자장애인화장실, 여자화장실, 여자장애인화장실, 현금지급기" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략소개</h4>
								<ul>
									<li>국회도서관 1층에 있는 대출대에서는 폐가제 서고에 소장된 단행본, 학위논문의 대출 및 반납, 정보검색 상담, 장애인 열람 서비스 등을 제공하고 있습니다.</li>
								</ul>
							</div>
							<div class="subBoxTxt">
								<h4>이용시간</h4>
								<ul>
									<li>월~금: 09:00 ~ 21:00 (온라인 열람신청 시간: 당일 09:00 ~ 17:00)</li>
									<li>토~일: 09:00 ~ 17:00 (온라인 열람신청 시간: 당일 09:00 ~ 16:00)</li>
								</ul>
							</div>
							<div class="subBoxTxt">
								<h4>
...
<!-- 										<a href="#" style="width: 114px;">열람신청 방법 보기</a> -->
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 1층(02-6788-4181, 4182, 4230)</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon09">
							<div class="mapImg">
								<img src="/resource/images/img_1F_02.jpg"
									alt="1층평면도 - 1.국가전략정보센터 위치 : 일반인출입구로 입장하여 출입게이트를 지나 중앙홀을 가로질러  대출대 오른쪽에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 남자장애인화장실, 여자화장실, 여자장애인화장실, 현금지급기" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략소개</h4>
								<ul>
									<li>국가전략정보센터는 국가전략과 관련된 국내외 최신 자료 및 글로벌 미래 이슈 자료를 소장하고 있습니다. 또한 연구 활동을 지원하기 위해 개인 열람석과 소규모 세미나 공간을 갖추고 있습니다.</li>
								</ul>
							</div>
							<div class="subBoxTxt">
								<h4>이용대상</h4>
...
<!-- 									<li>최근 1년의 국내 논문(학위수여년도 기준): 자료실에서 직접 이용</li> 
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 1층 107호(02-6788-4133, 4135)</li>
									<li class="bgNo">
										<img src="/resource/images/1F_02_01.png" alt="국가전략정보센터 내부사진. 1층 위치" style="width: 240px;height: 160px;"/>
										<img src="/resource/images/1F_02_02.png" alt="국가전략정보센터 내부사진. 1층 위치" style="width: 240px;height: 160px;"/>
										<img src="/resource/images/1F_02_03.png" alt="국가전략정보센터 내부사진. 1층 위치" style="width: 240px;height: 160px;"/>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon10">
							<div class="mapImg">
								<img src="/resource/images/img_1F_03.jpg"
									alt="1층평면도 - 1.어린이방 위치 : 일반인출입구로 입장하여 출입게이트를 지나 오른쪽으로 가면 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 남자장애인화장실, 여자화장실, 여자장애인화장실, 현금지급기" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략 소개</h4>
								<ul>
									<li>어린이방(105호)은 동화집, 위인전기, 어린이 잡지, 어린이 신문 등을 소장하고 있으며, 어린이와 보호자를 위한 공간을 제공하고 있습니다.</li>
								</ul>
							</div>
							<div class="subBoxTxt">
								<h4>이용시간</h4>
...
<!-- 								</p> -->
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 1층 105호(02-6788-4233)</li>
								</ul>
							</div>
						</div>
						...
						<div class="mapImageComent mt50 classListCon11">
							<div class="mapImg">
								<img src="/resource/images/img_1F_04.jpg"
							...
							<div class="subBoxTxt mt20">
								...
								<ul>
									<li>국회도서관은 복사실(106호) 운영을 외부위탁업체에 위탁하고 있습니다. 도서관 자료는 자율복사, 복사업체를 통한 위탁복사, 우편복사가 가능하며, 자료의 복사와 출력은 유료입니다.
									<span class="btnView m_ml10 pop_print"
										style="float: none; margin-left: 10px; display: inline-block;">
									...
									<!-- <li style="background: none;">
										<div class="btnView m_ml10">
											<a href="http://isform.co.kr/form/view/clopy/1083" title="새창열림"
												target="_blank"> <img src="/images/bg/btn_icon_001.png"
												alt="" />우편복사 신청하기
											</a>
										</div>
									</li> -->
...
<!-- 							</div> -->
		         						...
		         						<ul class="ml10" style="padding-left: 10px;">
											...
											<li class="end pL0">
												<div class="btnView m_ml10" style="float: left; margin-left: 10px;">
							                        	...
							                        	<a href="http://post.clopy.net" target="_blank" title="새창열림"><img src="/images/bg/btn_icon_001.png" alt="" />우편복사 신청하기</a>
											...
											<li class="end">
												<div class="btnView m_ml10" style="float: right; margin-left: -8px;">
													<a href="javascript:fileDown2('pcfApp.hwp','우편복사팩스신청서.hwp');" title="신청서 다운로드">
				                                        <img src="/images/bg/btn_icon_01.png" alt="" />신청서 다운로드
				                                    </a>
												</div>											
											</li>
										</ul>										
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 1층 106호(02-6788-4175)</li>
								</ul>
...
<!-- 								</p> -->
						...
						<div class="mapImageComent mt50 classListCon12">
							<div class="mapImg">
								<img src="/images/img/img_B1F_01.jpg"
						...
						<div class="mapImageComent mt50 classListCon13">
							<div class="mapImg">
								<img src="/images/img/img_B1F_02.jpg"
						...
						<div class="mapImageComent mt50 classListCon14">
							<div class="mapImg">
								<img src="/images/img/img_B1F_03.jpg"
						...
						<div class="mapImageComent mt50 classListCon15">
							<div class="mapImg">
								<img src="/images/img/img_B1F_04.jpg" alt="지하평면도 - 1.식당 위치 : 일반인출입구로 입장하여 여자화장실을 지나 강당 맞은편 매점 뒷쪽에 위치합니다. 2.편의시설 : 엘리베이터, 공중전화, 남자화장실, 여자화장실" />
							</div>
							<div class="subBoxTxt">
								<h4>BIF 식당</h4>
								<ul>
						...
						<div class="mapImageComent mt50 classListCon16">
							<div class="mapImg">
								<img src="/images/img/img_3F_01.jpg"
...
<!-- 							</div> -->
								...
								<ul>
									...
									<li style="background: none;">
										<div class="btnView m_ml10">
													...
													<a href="https://mdis.kostat.go.kr/" title="새창열림" target="_blank"><img src="/images/bg/btn_icon_001.png" alt="" />이용신청 바로하기</a>
							...
							<div class="mapImg">
								<img src="/images/img/img_3F_01_01.jpg" alt="이용센터서비스 이용 프로세스" />
							</div>
						...
						<div class="mapImageComent mt50 classListCon17">
							<div class="mapImg">
								<img src="/resource/images/img_1F_05.jpg"
							...
							<div class="subBoxTxt mt20">
								<h4>빅데이터 연구센터 소개</h4>
								<ul>
									<li>국회도서관 빅데이터 연구센터는 통계청의 통계데이터센터(SDC), 마이크로데이터 이용센터(RDC), 서울시 빅데이터 캠퍼스, 국회도서관 데이터 라이브러리를 통합하여 운영하고 있습니다.</li>
									<li>통계 소프트웨어를 사용할 수 있는 통계분석용 PC 및 데이터분석 전문도서코너가 있습니다.</li>
								</ul>
							</div>
							
							<div class="mapImg2">
								<img src="/resource/images/bigdata01.jpg" class="pc_w60" alt="국회도서관 빅데이터 연수센터(가칭)통계청RDC/SDC ·인구동향조사등 연구데이터·유동인구정보등 통계데이터 국회도서관 데이터 라이브러리 ·국회회의록 빅데이터 ·국가학술정보융합데이터 서울특별시 빅데이터 캠퍼스 ·서울시데이터 ·교통, 카드, 지역상권정보등 ·국회 직원 맞춤형 교육 지원" />
							</div>
							...
							<table class="normalTable">
								...
								<tr>
									<th scope="row"  style="background:none;" class="m_tCen">
										<img src="/resource/images/bigdata02.png"  alt="" class="big_wd" />
								...
								<tr>
									<th scope="row"  style="background:none;" class="m_tCen">
										<img src="/resource/images/bigdata03.png"  alt="" class="big_wd" />
								...
								<tr>
									<th scope="row"  style="background:none;" class="m_tCen">
										<img src="/resource/images/bigdata04.png"  alt="" class="big_wd" />
											...
											<ul style="margin-left:0px;">
												<li class="bgNo rightbo pr17 " style="padding-left:0px;">
													...
													<span class="btnView pop_sdc" style="float: none;"> 
														<img src="/resource/images/sdc.png" class="sdc mover" alt="통계청 SDC"  data-focus="popSdc" />
													</span>
												...
												<li class="bgNo rightbo rightbo0 "  style="padding-left:0px;">
													...
													<span  class="pop_rdc" style="cursor:pointer;">
														<img src="/resource/images/rdc.png" class="rdc mover" alt="통계청 RDC" data-focus="popRdc"/> 
													</span>
												...
												<li class="bgNo rightbo pr17 "  style="padding-left:0px;">
													...
													<span class="pop_seoul">   
														<img src="/resource/images/seoulBig.png" class="seoul mover" alt="서울시 빅데이터 캠퍼스" data-focus="popSeoul" />
													</span>
												...
												<li class="bgNo "  style="padding-left:0px;">
													<a href="#" class="pop_nal" data-focus="popNal" style="text-decoration:none !important;">
														...
														<span>
															<img src="/resource/images/dataNal.png" class="dataNal mover" alt="데이터 라이브러리"  />
														</span>
													</a>											
<!-- 													<div class="box707"> -->
...
<!-- 													</div>	 -->
							...
							<div class="subBoxTxt">
								<h4>문의</h4>
								<ul>
									<li>빅데이터연구센터(02-6788-4392, 4416)</li>
									<li>데이터융합분석과(02-6788-4476)</li>
								</ul>
							</div>
						...
						<div class="mapImageComent mt50 classListCon18">
							<div class="mapImg">
								<img src="/resource/images/img_1F_06.jpg"
									alt="1층평면도 - 1.장애인석 위치 : 일반인출입구로 입장하여 출입게이트를 지나 중앙홀을 가로질러 대출대 왼쪽편에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 남자장애인화장실, 여자화장실, 여자장애인화장실, 현금지급기" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략 소개</h4>
								<ul>
									<li>국회도서관 1층에 위치한 장애인석은 장애인용 PC 3석으로 구성되어 있습니다. 각 PC 마다 높낮이 조절이 가능한 전동테이블이 설치되어 있으며, 각종 장애인용 열람보조기기가 비치되어 있습니다.</li>
								</ul>
							</div>
							<div class="subBoxTxt">
								<h4>이용 시간</h4>
							...
							<div class="subBoxTxt">
								<h4>위치 및 전화번호</h4>
								<ul>
									<li>국회도서관 1층 장애인석(대출대 02-6788-4230)</li>
								</ul>
							</div>
						...
						<div class="mapImageComent mt50 classListCon19">
							<div class="mapImg">
								<img src="/resource/images/img_1F_07.jpg"
									alt="1층평면도 - 1.상설전시실 위치 : 일반인출입구로 입장하여 출입게이트를 지나 중앙홀을 가로질러 왼쪽편에 위치합니다. 2.편의시설 : 엘리베이터, 남자화장실, 남자장애인화장실, 여자화장실, 여자장애인화장실, 현금지급기" />
							</div>
							<div class="subBoxTxt mt20">
								<h4>간략 소개</h4>
								<ul>
									<li>대한민국 임시의정원 개원 100주년을 기념하여, 1919년부터 1945년까지 존속했던 임시의정원의
										주요한 활동을 살펴볼 수 있는 전시를 기획하여 운영하고 있습니다. 상설전시실에는 임시의정원 의장을 세 차례
										역임한 홍진 선생이 1945년 환국할 때 가지고 들어온 「대한민국 임시의정원 문서」(등록문화재 제710호) 중
										중요 문서 40여 점이 전시되어 있습니다.</li>
								</ul>
							</div>
<!-- 							<div class="subBoxTxt"> -->
<!-- 								<h4>이용 시간</h4> -->
...
<!-- 							</div> -->
							...
							<div class="subBoxTxt">
								...
								<ul>
									<li>위치 : 국회도서관 1층</li>
									<li>문의 : 기록보존소 기록정책과(02-6788-4449)</li>
								</ul>
							</div>				
...
<!-- 						<li class="bgNo"><img src="/resource/images/sdc2.jpg" alt="통계청 SDC" class="w_sdc"></li> -->
					</ul>
				</div>		
           ...
           <div class="mapImg"> <img src="/resource/images/sdc1.jpg" alt="이용방법 절차 안내 이미지" class="w_sdc"></div>
			...
			<div class="jengBtn mb20">
				...
				<a href="https://data.kostat.go.kr/sbchome/contents/cntPage.do?cntntsId=CNTS_000000000000104&curMenuNo=T_01_04_00_0OP" title="새창열기" target="_blank">
					<img src="/images/bg/btn_icon_001.png" alt="">이용 신청 및 데이터 확인하기
				</a>
...
<!-- 						<li class="bgNo"><img src="/resource/images/sdc2.jpg" alt="통계청 SDC" class="w_sdc"></li> -->
					...
					<ul>
						<li class="bgNo">
						<div><img src="/resource/images/rdc1.jpg" alt="로그인>서양석동의>이용센터서비스 신청서작성>연구계획서 검토 후 승인>이용자 준수사항 동의 및 결제>이용자료 생성 > 이용센터 서비스 방문 분석작업>데이터 반출 검토 후 승인 >MDIS 웹사이트에서 다운로드" class="w_rdc"></div>
						</li>
					</ul>					
